...
\projectinfo{
  ...
  %Skolitel / supervisor
  supervisor=Tomáš Milét, %cele jmeno a prijmeni skolitele / full name and surname of the supervisor
  supervisor.name={Tomáš},   %jmeno skolitele (pro citaci) / supervisor name (for reference) 
  supervisor.surname={Milét},   %prijmeni skolitele (pro citaci) / supervisor surname (for reference) 
...
\abstract[cs]{
Práce se zabývá realnou implementaci jednoduchého dema v prostředí OpenGL.  	
}
\abstract[en]{Do tohoto odstavce bude zapsán výtah (abstrakt) práce v anglickém jazyce.}

%Klicova slova (cesky, slovensky ci anglicky) / Keywords (in czech, slovak or english)
\keywords[cs]{OpenGL, 3D hra, }
\keywords[en]{OpenGL 3D game}
