...
/ CD
\begin{itemize}
\item[/] \itab{3rd\_parties} 	\tab{-Obsah je z převážné části tvorbou třetích stran} 					
	\begin{itemize}
	\item[/] \itab{authors.txt} \tab{-zde jsou uvedeny zdroje a autoři souborů.}
...
\item[/] \itab{src} \tab{ 				-soubory aplikace}
	\begin{itemize}
		\item[/] \itab{InteractiveOpenGLDemo} \tab{-zdrojové kódy výsledné aplikace a spouštěcí soubor}
	\end{itemize}
